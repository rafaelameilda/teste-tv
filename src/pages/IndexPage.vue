  ...
  data() {
    return {
      ...
      playlist: [
        ...
        { type: "image", time: 5000, url: "/images/imagem (1).jfif" },
        { type: "image", time: 5000, url: "/images/imagem (2).jfif" },
        { type: "image", time: 5000, url: "/images/imagem (3).jfif" },
        { type: "image", time: 5000, url: "/images/imagem (4).jfif" },
        { type: "image", time: 5000, url: "/images/imagem (5).jfif" },
        { type: "image", time: 5000, url: "/images/imagem (6).jfif" },
        { type: "image", time: 5000, url: "/images/imagem (7).jfif" },
        { type: "image", time: 5000, url: "/images/imagem (8).jfif" },
        { type: "image", time: 5000, url: "/images/imagem (9).jfif" },
        { type: "image", time: 5000, url: "/images/imagem (10).jfif" },
        { type: "image", time: 5000, url: "/images/imagem (11).jfif" },
        { type: "image", time: 5000, url: "/images/imagem (12).jfif" },
        { type: "image", time: 5000, url: "/images/imagem (13).jfif" },
        { type: "image", time: 5000, url: "/images/imagem (14).jfif" },
        { type: "image", time: 5000, url: "/images/imagem (15).jfif" },
        { type: "image", time: 5000, url: "/images/imagem (16).jfif" },
        { type: "image", time: 5000, url: "/images/imagem (17).jfif" },
        { type: "image", time: 5000, url: "/images/imagem (18).jfif" },
        { type: "image", time: 5000, url: "/images/imagem (19).jfif" },
        { type: "image", time: 5000, url: "/images/imagem (20).jfif" },
      ],
      slideTimeout: null,
